 ...
 */
namespace Evalent\EcsterPay\Block\Adminhtml\Sales\Order\Invoice\Totals\View;

use Magento\Framework\View\Element\Template\Context;
use Magento\Tax\Model\Config;

class ExtraFee extends \Evalent\EcsterPay\Block\Adminhtml\Sales\Order\Invoice\Totals\ExtraFee
{
    protected $_order;
    protected $_source;
